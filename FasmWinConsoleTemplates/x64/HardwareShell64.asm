...
; Definitions for color console support
; Color masks
...
; Make demo with CPU registers dump, use subroutines from DUMPCPU.INC.
...
TitleString        DB  'Hardware Shell v0.20 (x64)', 0
CrLf2              DB  0Dh, 0Ah
CrLf               DB  0Dh, 0Ah, 0
...
OptionSrcfile      DQ  BufferSrc      ; source file path, used for read and write
OptionDstfile      DQ  BufferDst      ; destination file path, used for copy as destination
; Test files names
