...
test rax,rax
jz .functionNotFound
mov [_GetLogicalProcessorInformationEx],rax
...
xchg rbp,rax
lea r8,[BufferLength]
mov dword [r8],LIMIT_ENUM
lea rdx,[rbp + BASE_ENUM]
mov rsi,rdx
mov ecx,0FFFFh
...
resdata guistrings
DB  'SMP extended topology list (x64 v0.02)' , 0
