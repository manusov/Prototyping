...
BUFFER_ST0     = TEXT_PER_REG * 8
BUFFER_ST1     = TEXT_PER_REG * 9
BUFFER_ST2     = TEXT_PER_REG * 10
BUFFER_ST3     = TEXT_PER_REG * 11
BUFFER_ST4     = TEXT_PER_REG * 12
BUFFER_ST5     = TEXT_PER_REG * 13
BUFFER_ST6     = TEXT_PER_REG * 14
BUFFER_ST7     = TEXT_PER_REG * 15
BIND_APP_GUI   = 0
X_SIZE         = 129
Y_SIZE         = 169
COUNT_GPR      = 8
...
dialogitem 'STATIC', '', IDR_ST0_NAME  ,  5,  86,  28,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_ST1_NAME  ,  5,  95,  28,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_ST2_NAME  ,  5, 104,  28,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_ST3_NAME  ,  5, 113,  28,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_ST4_NAME  ,  5, 122,  28,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_ST5_NAME  ,  5, 131,  28,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_ST6_NAME  ,  5, 140,  28,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_ST7_NAME  ,  5, 149,  28,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
...
dialogitem 'STATIC', '', IDR_ST0_VALUE , 34,  86,  82,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_ST1_VALUE , 34,  95,  82,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_ST2_VALUE , 34, 104,  82,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_ST3_VALUE , 34, 113,  82,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_ST4_VALUE , 34, 122,  82,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_ST5_VALUE , 34, 131,  82,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_ST6_VALUE , 34, 140,  82,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_ST7_VALUE , 34, 149,  82,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
enddialog
