...
mov ecx,COUNT_MMX
sub rsp,64
movq qword [rsp + 8*0],mm0
movq qword [rsp + 8*1],mm1
movq qword [rsp + 8*2],mm2
movq qword [rsp + 8*3],mm3
movq qword [rsp + 8*4],mm4
movq qword [rsp + 8*5],mm5
movq qword [rsp + 8*6],mm6
movq qword [rsp + 8*7],mm7
.mmxDump:
pop rax
call HexPrint64
mov al,0
