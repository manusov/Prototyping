...
IDR_XMM8_0_VALUE  = 516
IDR_XMM8_1_VALUE  = 517
IDR_XMM9_0_VALUE  = 518   
IDR_XMM9_1_VALUE  = 519
IDR_XMM10_0_VALUE = 520
IDR_XMM10_1_VALUE = 521
IDR_XMM11_0_VALUE = 522
IDR_XMM11_1_VALUE = 523
IDR_XMM12_0_VALUE = 524
IDR_XMM12_1_VALUE = 525
IDR_XMM13_0_VALUE = 526
IDR_XMM13_1_VALUE = 527
IDR_XMM14_0_VALUE = 528
IDR_XMM14_1_VALUE = 529
IDR_XMM15_0_VALUE = 530
IDR_XMM15_1_VALUE = 531
STRING_APP        = 0
STRING_RAX        = 1
STRING_RBX        = 2
STRING_RCX        = 3
...
BUFFER_XMM0_0     = TEXT_PER_REG * 24
BUFFER_XMM0_1     = TEXT_PER_REG * 25
BUFFER_XMM1_0     = TEXT_PER_REG * 26
BUFFER_XMM1_1     = TEXT_PER_REG * 27
BUFFER_XMM2_0     = TEXT_PER_REG * 28
BUFFER_XMM2_1     = TEXT_PER_REG * 29
BUFFER_XMM3_0     = TEXT_PER_REG * 30
BUFFER_XMM3_1     = TEXT_PER_REG * 31
BUFFER_XMM4_0     = TEXT_PER_REG * 32
BUFFER_XMM4_1     = TEXT_PER_REG * 33
BUFFER_XMM5_0     = TEXT_PER_REG * 34
BUFFER_XMM5_1     = TEXT_PER_REG * 35
BUFFER_XMM6_0     = TEXT_PER_REG * 36
BUFFER_XMM6_1     = TEXT_PER_REG * 37
BUFFER_XMM7_0     = TEXT_PER_REG * 38
BUFFER_XMM7_1     = TEXT_PER_REG * 39
BUFFER_XMM8_0     = TEXT_PER_REG * 40
BUFFER_XMM8_1     = TEXT_PER_REG * 41
BUFFER_XMM9_0     = TEXT_PER_REG * 42
BUFFER_XMM9_1     = TEXT_PER_REG * 43
BUFFER_XMM10_0    = TEXT_PER_REG * 44
BUFFER_XMM10_1    = TEXT_PER_REG * 45
BUFFER_XMM11_0    = TEXT_PER_REG * 46
BUFFER_XMM11_1    = TEXT_PER_REG * 47
BUFFER_XMM12_0    = TEXT_PER_REG * 48
BUFFER_XMM12_1    = TEXT_PER_REG * 49
BUFFER_XMM13_0    = TEXT_PER_REG * 50
BUFFER_XMM13_1    = TEXT_PER_REG * 51
BUFFER_XMM14_0    = TEXT_PER_REG * 52
BUFFER_XMM14_1    = TEXT_PER_REG * 53
BUFFER_XMM15_0    = TEXT_PER_REG * 54
BUFFER_XMM15_1    = TEXT_PER_REG * 55
BUFFER_N_MM0      = TEXT_PER_REG * 56
...
BUFFER_N_XMM8     = BUFFER_N_XMM0 + TEXT_PER_XMM * 8
BUFFER_N_XMM9     = BUFFER_N_XMM0 + TEXT_PER_XMM * 9
BUFFER_N_XMM10    = BUFFER_N_XMM0 + TEXT_PER_XMM * 10
BUFFER_N_XMM11    = BUFFER_N_XMM0 + TEXT_PER_XMM * 11
BUFFER_N_XMM12    = BUFFER_N_XMM0 + TEXT_PER_XMM * 12
BUFFER_N_XMM13    = BUFFER_N_XMM0 + TEXT_PER_XMM * 13
BUFFER_N_XMM14    = BUFFER_N_XMM0 + TEXT_PER_XMM * 14
BUFFER_N_XMM15    = BUFFER_N_XMM0 + TEXT_PER_XMM * 15
BIND_APP_GUI      = 0
X_SIZE            = 276
Y_SIZE            = 242
COUNT_GPR         = 16
...
mov cl,COUNT_SSE
sub rsp,256
movupd [rsp + 16*00],xmm0
movupd [rsp + 16*01],xmm1
movupd [rsp + 16*02],xmm2
movupd [rsp + 16*03],xmm3
movupd [rsp + 16*04],xmm4
movupd [rsp + 16*05],xmm5
movupd [rsp + 16*06],xmm6
movupd [rsp + 16*07],xmm7
movupd [rsp + 16*08],xmm8
movupd [rsp + 16*09],xmm9
movupd [rsp + 16*10],xmm10
movupd [rsp + 16*11],xmm11
movupd [rsp + 16*12],xmm12
movupd [rsp + 16*13],xmm13
movupd [rsp + 16*14],xmm14
movupd [rsp + 16*15],xmm15
.sseDump:
mov bp,COUNT_VECTOR
.vectorDump:
pop rax
...
dialogitem 'STATIC', '', IDR_XMM8_NAME     , 124,  81,  36,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM9_NAME     , 124,  90,  36,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM10_NAME    , 124,  99,  36,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM11_NAME    , 124, 108,  36,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM12_NAME    , 124, 117,  36,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM13_NAME    , 124, 126,  36,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM14_NAME    , 124, 135,  36,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM15_NAME    , 124, 144,  36,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
...
dialogitem 'STATIC', '', IDR_XMM8_0_VALUE  , 214,  81,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM8_1_VALUE  , 161,  81,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM9_0_VALUE  , 214,  90,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM9_1_VALUE  , 161,  90,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM10_0_VALUE , 214,  99,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM10_1_VALUE , 161,  99,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM11_0_VALUE , 214, 108,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM11_1_VALUE , 161, 108,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM12_0_VALUE , 214, 117,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM12_1_VALUE , 161, 117,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM13_0_VALUE , 214, 126,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM13_1_VALUE , 161, 126,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM14_0_VALUE , 214, 135,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM14_1_VALUE , 161, 135,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM15_0_VALUE , 214, 144,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
dialogitem 'STATIC', '', IDR_XMM15_1_VALUE , 161, 144,  52,  8, WS_VISIBLE + SS_SUNKEN + SS_CENTER + SS_CENTERIMAGE
enddialog
...
resdata guistrings
DB  'GPR64, MMX and SSE (x64 v0.01)', 0
DB  'RAX', 0
DB  'RBX', 0
DB  'RCX', 0
DB  'RDX', 0
...
BIND_INFO    BUFFER_N_XMM8  , IDR_XMM8_NAME
BIND_INFO    BUFFER_N_XMM9  , IDR_XMM9_NAME
BIND_INFO    BUFFER_N_XMM10 , IDR_XMM10_NAME
BIND_INFO    BUFFER_N_XMM11 , IDR_XMM11_NAME
BIND_INFO    BUFFER_N_XMM12 , IDR_XMM12_NAME
BIND_INFO    BUFFER_N_XMM13 , IDR_XMM13_NAME
BIND_INFO    BUFFER_N_XMM14 , IDR_XMM14_NAME
BIND_INFO    BUFFER_N_XMM15 , IDR_XMM15_NAME
...
BIND_INFO    BUFFER_XMM8_0  , IDR_XMM8_0_VALUE
BIND_INFO    BUFFER_XMM8_1  , IDR_XMM8_1_VALUE
BIND_INFO    BUFFER_XMM9_0  , IDR_XMM9_0_VALUE
BIND_INFO    BUFFER_XMM9_1  , IDR_XMM9_1_VALUE
BIND_INFO    BUFFER_XMM10_0 , IDR_XMM10_0_VALUE
BIND_INFO    BUFFER_XMM10_1 , IDR_XMM10_1_VALUE
BIND_INFO    BUFFER_XMM11_0 , IDR_XMM11_0_VALUE
BIND_INFO    BUFFER_XMM11_1 , IDR_XMM11_1_VALUE
BIND_INFO    BUFFER_XMM12_0 , IDR_XMM12_0_VALUE
BIND_INFO    BUFFER_XMM12_1 , IDR_XMM12_1_VALUE
BIND_INFO    BUFFER_XMM13_0 , IDR_XMM13_0_VALUE
BIND_INFO    BUFFER_XMM13_1 , IDR_XMM13_1_VALUE
BIND_INFO    BUFFER_XMM14_0 , IDR_XMM14_0_VALUE
BIND_INFO    BUFFER_XMM14_1 , IDR_XMM14_1_VALUE
BIND_INFO    BUFFER_XMM15_0 , IDR_XMM15_0_VALUE
BIND_INFO    BUFFER_XMM15_1 , IDR_XMM15_1_VALUE
BIND_STOP
endres
