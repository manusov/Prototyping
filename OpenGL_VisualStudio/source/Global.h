...
// Application title strings and x64/ia32 differentiation constants.
	const char* const APP_NAME = "OpenGL GPUstress (C++ edition). Engineering sample #19.";
#if _WIN64
...
// Render objects count = 128 * 5 + 27 + duplications for GPU load.
	...
	constexpr int DEFAULT_GPU_LOAD_SELECT  = 2;
	constexpr int MAXIMUM_GPU_LOAD_SELECT  = 7;
	constexpr int DEFAULT_GPU_LOAD         = INSTANCING_COUNT_LOAD_2;
